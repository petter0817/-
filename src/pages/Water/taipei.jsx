...
function Taipei() {
  ...
  useEffect(()=>{
    fetchweatherElementTaipei()
    fetchweatherForecastTaipei()
  },[])
  const fetchweatherElementTaipei = () => {
    fetch(
      'https://opendata.cwb.gov.tw/api/v1/rest/datastore/O-A0003-001?Authorization=CWB-E8944CB0-6F57-4652-89C7-8C79CAAECF9C&locationName=臺北'
    )
  ...
  const fetchweatherForecastTaipei = () => {
    fetch(
      'https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWB-E8944CB0-6F57-4652-89C7-8C79CAAECF9C&locationName=臺北市'
    )
      .then(response => response.json())
      .then(data => {
        console.log('data', data);
